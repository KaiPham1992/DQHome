...
class AppButtonPopUp: UIButton {
    ...
    func setUpViews() {
        ...
        self.setTitleColor(AppColor.white, for: UIControlState.highlighted)
        self.setTitleColor(AppColor.white, for: UIControlState.normal)
        self.setTitleColor(AppColor.white, for: UIControlState.selected)
    }
