...
//            }
    ...
    private func showPopWithAnimation(type: BasePopUpViewType) {
        ...
        case .fromBottomToCenter, .fromLeftToCenter, .fromRightToCenter, .fromTopToCenter:
            UIView.animate(withDuration: 0.5, delay: 0, usingSpringWithDamping: 0.6, initialSpringVelocity: 1, options: UIViewAnimationOptions.curveEaseOut, animations: { [unowned self] in
                self.vBackGround.alpha = 1
