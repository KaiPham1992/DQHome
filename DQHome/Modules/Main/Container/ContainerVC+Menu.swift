...
extension ContainerViewController {
    ...
    func addMenuViewController(vcMenu: UIViewController) {
        ...
        vcMenu.view.widthAnchor.constraint(equalTo: vContainerMain.widthAnchor, multiplier: 215/960, constant: 0).isActive = true
    ...
    func showMenu() {
        ...
        let vcMenu = isLeftMenu == true ? vcLeftMenu: vcRightMenu
        addTapGesture()
...
//        imgLeftMenu.isHidden = true
//        self.btnRightMenu.isHidden = false
//        self.imgRightMenu.isHidden = false
        
        widthMenu = 215 * self.vContainerMain.frame.width / 960
...
//        imgRightMenu.isHidden = true
//        self.btnLeftMenu.isHidden = false
//        self.imgLeftMenu.isHidden = false
        widthMenu = 215 * self.vContainerMain.frame.width / 960
        vcRightMenu.view.frame = CGRect(x: self.vContainerMain.frame.width + widthMenu, y: 0, width: widthMenu, height: self.vBlack.frame.height)
        
        UIView.animate(withDuration: 0.3, delay: 0, options: .curveEaseOut, animations: {
            self.vcRightMenu.view.frame = CGRect(x: self.vContainerMain.frame.width - self.widthMenu, y: 0, width: self.widthMenu, height: self.vBlack.frame.height)
        }) { _ in
